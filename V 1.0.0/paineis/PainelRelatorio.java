...
public class PainelRelatorio extends JPanel{
	...
	public PainelRelatorio() {
		...
		btnRelatorioOS.setIcon(new ImageIcon(PainelRelatorio.class.getResource("/img/download.png")));
		BotaoMenu btnRelatorioClientes = new BotaoMenu("Clientes", 32, 308, 430, 73);
		btnRelatorioClientes.setIcon(new ImageIcon(PainelRelatorio.class.getResource("/img/download.png")));
		BotaoMenu btnRelatorioVeiculos = new BotaoMenu("Veiculos", 32, 389, 430, 73);
		btnRelatorioVeiculos.setIcon(new ImageIcon(PainelRelatorio.class.getResource("/img/download.png")));
		BotaoMenu btnRelatorioFuncionarios = new BotaoMenu("Funcionarios", 32, 470, 430, 73);
		btnRelatorioFuncionarios.setIcon(new ImageIcon(PainelRelatorio.class.getResource("/img/download.png")));
		
		BotaoMenu btnRelatorioProdutos = new BotaoMenu("Produtos", 489, 227, 430, 73);
		btnRelatorioProdutos.setIcon(new ImageIcon(PainelRelatorio.class.getResource("/img/download.png")));
		BotaoMenu btnRelatorioFaturamentoProdutos = new BotaoMenu("Faturamento Produtos", 489, 308, 430, 73);
		btnRelatorioFaturamentoProdutos.setIcon(new ImageIcon(PainelRelatorio.class.getResource("/img/download.png")));
		BotaoMenu btnRelatorioFaturamentoServicos = new BotaoMenu("Faturamento Serviços", 489, 389, 430, 73);
		btnRelatorioFaturamentoServicos.setIcon(new ImageIcon(PainelRelatorio.class.getResource("/img/download.png")));
