...
public class PainelProdutos extends JPanel{
	...
	public PainelProdutos() {
		...
		btnCadastrarProdutos.setIcon(new ImageIcon(PainelProdutos.class.getResource("/img/cadastrar.png")));
		BotaoMenu btnConsultarProdutos = new BotaoMenu("Consultar Produtos", 252, 330, 538, 73);
		btnConsultarProdutos.setIcon(new ImageIcon(PainelProdutos.class.getResource("/img/consultar.png")));
