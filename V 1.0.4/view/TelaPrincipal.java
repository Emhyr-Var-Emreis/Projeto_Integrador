...
public class TelaPrincipal {
	...
	private BotaoMenu btnRelatorios;
	
	

	public BotaoMenu getBtnRelatorios() {
		return btnRelatorios;
	}

	public void setBtnRelatorios(BotaoMenu btnRelatorios) {
	...
	public TelaPrincipal() {
        ...
        btnRelatorios = new BotaoMenu("Relatorios",0, 412, 326, 78);
