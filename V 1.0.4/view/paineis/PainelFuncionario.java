...
public class PainelFuncionario extends JPanel{
	...
	public PainelFuncionario() {
		...
		btnCadastrarFuncionario.setIcon(new ImageIcon(PainelFuncionario.class.getResource("/view/img/cadastrar.png")));
		BotaoMenu btnConsultarFuncionario = new BotaoMenu("Consultar Funcionario", 252, 330, 538, 73);
		btnConsultarFuncionario.setIcon(new ImageIcon(PainelFuncionario.class.getResource("/view/img/consultar.png")));
		...
		btnConsultarFuncionario.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				removeAll();
				PainelConsultarFuncionarios painelConsultarFuncionario = new PainelConsultarFuncionarios();
				add(painelConsultarFuncionario);
				revalidate();
				repaint();
