...
public class BotaoLimpar extends JButton {

	private static final long serialVersionUID = -5056732040663035291L;

	public BotaoLimpar(String texto) { // Cria um construtor que recebe um texto como parâmetro
        ...
        setIcon(new ImageIcon(BotaoLimpar.class.getResource("/view/img/limpar.png")));
