...
public class PainelClientes extends JPanel{
	...
	public PainelClientes() {
		...
		btnCadastrarCliente.setIcon(new ImageIcon(PainelClientes.class.getResource("/view/img/cadastrar.png")));
		BotaoMenu btnConsultarCliente = new BotaoMenu("Consultar Cliente", 252, 330, 538, 73);
		btnConsultarCliente.setIcon(new ImageIcon(PainelClientes.class.getResource("/view/img/consultar.png")));
		...
		btnConsultarCliente.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				removeAll();
				PainelConsultarClientes painelConsultarCliente = new PainelConsultarClientes();
				add(painelConsultarCliente);
				revalidate();
				repaint();
