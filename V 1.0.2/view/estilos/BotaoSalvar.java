...
public class BotaoSalvar extends JButton {
	...
	private static final long serialVersionUID = -2268995973762076435L;
	...
	public BotaoSalvar(String texto) { // Cria um construtor que recebe um texto como parâmetro
        ...
        setIcon(new ImageIcon(BotaoSalvar.class.getResource("/view/img/Salvar.png")));
